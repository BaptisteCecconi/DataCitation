...
class TestURIRefDoi:
    """Tests for the URIRefDoi function"""

    def test_doi_https_full_url(self):
    ...
    def test_doi_invalid_syntax(self):
...
class TestShortenDoi:
    """Tests for the shorten_doi function"""

    def test_shorten_doi_full_url(self):
    ...
    def test_shorten_doi_already_short(self):
    ...
    def test_shorten_doi_case_sensitivity(self):
...
class TestURIRefBibcode:
    """Tests for the URIRefBibcode function"""

    def test_bibcode_ads_full_url(self):
    ...
    def test_bibcode_ui_ads_to_ads(self):
...
class TestURIRefArXiv:
    """Tests for the URIRefArXiv function"""
    ...
    def test_arxiv_case_sensitivity(self):
...
class TestReverse:
    ...
    @patch("data_citation_reporter.rdf.REVERSE_PROPERTY")
    def test_reverse_existing_predicate(self, mock_reverse_property):
    ...
    @patch("data_citation_reporter.rdf.REVERSE_PROPERTY")
    def test_reverse_missing_predicate(self, mock_reverse_property):
...
class TestCustomGraph:
    ...
    def test_add_with_prov_none(self):
    ...
    def test_add_with_prov_with_metadata(self):
    ...
    def test_add_with_prov_multiple_provenance(self):
    ...
    def test_add_with_prov_empty_provenance_dict(self):
    ...
    def test_add_with_prov_none_provenance(self):
